...
public class MNWSInfoRequestAnyGame extends MNWSInfoRequest
 {
  public MNWSInfoRequestAnyGame (int gameId, IEventHandler eventHandler)
   {
    this.gameId       = gameId;
  ...
  void handleRequestCompleted (MNWSResponse       response)
   {
    MNWSAnyGameItem data = (MNWSAnyGameItem)response.getDataForBlock(blockName);
  ...
  public static class RequestResult extends MNWSInfoRequest.RequestResult
   {
    ...
    private RequestResult (MNWSAnyGameItem data)
     {
      super();
